...
!(function (e, t) {
    ...
    (_.Scene = function (e) {
          ...
          R.type.Function(o) &&
            (e = e.trim().split(' ')).forEach(function (e) {
              var t = e.split('.'),
                ...
                r = t[1];
              '*' != n &&
                (s[n] || (s[n] = []), s[n].push({ namespace: r || '', callback: o }));
            }),
          d
        );
      }),
      ...
      (this.controller = function () {
        ...
        (this.triggerPosition = function () {
          var e = h.offset;
          return (
            l && (h.triggerElement ? (e += v) : (e += l.info('size') * d.triggerHook())),
            e
          );
        }),
        d
      ...
      function L(e) {
        l &&
          ...
          l._setScrollPos(
            l.info('scrollPos') -
              ((e.wheelDelta || e[l.info('vertical') ? 'wheelDeltaY' : 'wheelDeltaX']) /
                3 || 30 * -e.detail)
          ));
      }
      var T = function (e) {
  ...
  var R = (_._util = (function (s) {
    ...
    function r(e, t, n, r) {
      ...
      var o,
        i =
          (n ? t['offset' + e] || t['outer' + e] : t['client' + e] || t['inner' + e]) ||
          0;
      return (
        n &&
          r &&
