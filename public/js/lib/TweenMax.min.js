        ...
        (k.render = function (a, b, d) {
          ...
          for (
            this._lazy !== !1 && (this._lazy = !1),
              this._active ||
                (!this._paused && this._time !== q && a >= 0 && (this._active = !0)),
              0 === r &&
                (2 === this._initted && a > 0 && this._init(),
                this._startAt &&
                  (a >= 0 ? this._startAt.render(a, !0, d) : f || (f = '_dummyGS')),
                this.vars.onStart &&
            ...
            i.f ? i.t[i.p](i.c * this.ratio + i.s) : (i.t[i.p] = i.c * this.ratio + i.s),
              (i = i._next);
          this._onUpdate &&
            (0 > a && this._startAt && this._startTime && this._startAt.render(a, !0, d),
        ...
        (f.killChildTweensOf = function (a, b) {
          if (null != a) {
            var e,
              ...
              n = h.tweenLookup;
            if (
              ('string' == typeof a && (a = c.selector(a) || a), i(a) && (a = d(a)), j(a))
            )
        ...
        return (
          ...
          (q.staggerTo = function (a, b, e, f, g, i, j, k) {
            ...
            for (
              ...
              (l = m(e)),
                l.startAt &&
                  ((l.startAt = m(l.startAt)), l.startAt.cycle && n(l.startAt, a, o)),
                r &&
                  (n(l, a, o),
            ...
            if (b instanceof a) {
              ...
              return (
                (b._startTime =
                  ...
                  (b._reversed ? b.totalDuration() - b._totalTime : b._totalTime) /
                    b._timeScale),
                this
              );
            }
          ...
          (q.render = function (a, b, c) {
            ...
            if ((this._time !== n && this._first) || c || i || l) {
              if (
                ...
                this._active ||
                  (!this._paused && this._time !== n && a > 0 && (this._active = !0)),
                0 === n &&
                  this.vars.onStart &&
          ...
          (k.render = function (a, b, c) {
            ...
            if ((o !== this._time && (a += this._time - o), a >= p - 1e-7 && a >= 0))
              ...
              if (
                ...
                if (
                  ((this._rawPrevTime = q || !b || a || this._rawPrevTime === a ? a : e),
                  0 === a && f)
                )
                  for (d = this._first; d && 0 === d._startTime; )
                    d._duration || (f = !1), (d = d._next);
            ...
            if (this._cycle !== w && !this._locked) {
              ...
              if (
                ...
                b ||
                  this._gc ||
                  (this.vars.onRepeat &&
                    ((this._cycle = A), (this._locked = !1), this._callback('onRepeat'))),
                o !== this._time)
              )
                return;
              if (
      ...
      var a = 180 / Math.PI,
        ...
        l = function (a, f, g, i, l, m) {
          ...
          if (a.length > 1) {
            ...
            t &&
              ((a = a.concat()), m && a.unshift(m), a.push(a[1]), (m = a[a.length - 3]));
          }
      ...
      function (a, b) {
        ...
        var Aa,
          ...
          Ma = function (a) {
            ...
            if (
              (Ja.appendChild(c), c.appendChild(this), (this.style.display = 'block'), a)
            )
              try {
                (b = this.getBBox()),
              ...
              if (
                ...
                for (
                  ...
                  (q = h[j]),
                    ...
                    k !== (-1 !== i[j].indexOf('%')) &&
                      ((l =
                        0 === j ? a.offsetWidth - R.width : a.offsetHeight - R.height),
                      (h[j] = k
        ...
        (j = g.prototype),
          ...
          (j._enableTransforms = function (a) {
            (this._transform = this._transform || Ra(this._target, e, !0)),
              (this._transformType =
                (this._transform.svg && Aa) || (!a && 3 !== this._transformType) ? 2 : 3);
          });
        var Ya = function (a) {
  ...
  (function (a, b) {
      ...
      (i.dispatchEvent = function (a) {
        ...
        if (e)
          for (b = e.length, b > 1 && (e = e.slice(0)), c = this._eventTarget; --b > -1; )
            (d = e[b]),
              d &&
                (d.up ? d.c.call(d.s || c, { type: a, target: c }) : d.c.call(d.s || c));
      });
    ...
    u('Ticker', function (a, b) {
      ...
      z.call(i),
        ...
        (i.sleep = function () {
          null != f &&
            (m && B ? B(f) : clearTimeout(f), (e = p), (f = null), i === j && (k = !1));
        }),
        (i.wake = function (a) {
          null !== f
            ? i.sleep()
    ...
    F(),
      ...
      (i.totalDuration = function (a) {
        return (
          (this._dirty = !1), arguments.length ? this.duration(a) : this._totalDuration
        );
      }),
      (i.time = function (a, b) {
        return arguments.length
      ...
      (i.totalTime = function (a, b, c) {
        ...
        if (this._timeline) {
          if (
            (0 > a && !c && (a += this.totalDuration()), this._timeline.smoothChildTiming)
          ) {
            this._dirty && this.totalDuration();
        ...
        if (this._time !== h || c) {
          ...
          for (
            this._lazy !== !1 && (this._lazy = !1),
              ...
              0 === h &&
                (this._startAt &&
                  (a >= 0 ? this._startAt.render(a, !0, c) : e || (e = '_dummyGS')),
                this.vars.onStart &&
                  (0 !== this._time || 0 === i) &&
                  (b || this._callback('onStart'))),
              f = this._firstPT;
